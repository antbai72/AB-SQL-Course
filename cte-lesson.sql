...
Select  DATEPART(YEAR,pp.TransactionDate) AS CalendarYear,
        sum(pp.Price) / 1000000.0 as TotalSoldMillions
  
from PricePaidSW12 pp

Group by DATEPART(YEAR,pp.TransactionDate)

Order BY
        CalendarYear

--Example 7/4   rounds to nearest whole number
...
SELECT
	SUM(pp.Price) / 1000000.0 AS TotalPriceInMillions
